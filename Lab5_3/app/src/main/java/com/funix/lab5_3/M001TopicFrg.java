    ...
    private void initViews(View v) {
        ...
        try {
            ...
            for (String fileName : listItem) {
                ...
                // tải và hiển thị một hình ảnh từ tệp tin nằm trong assets
                ...
                //thiết lập margin, cập nhật layout parameters, đặt tag và đăng ký sự kiện click cho một đối tượng vTopic của lớp LinearLayout.
